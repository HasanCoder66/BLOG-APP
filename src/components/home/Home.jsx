      ...
      <div className="topBarContainer">
        <div className="topBarLeft">
          <Link style={{ textDecoration: "none" }} to="/">
            <span className="logo">Tech Blog App</span>
          </Link>
        </div>
