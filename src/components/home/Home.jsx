...
import { Link } from "react-router-dom";
    ...
    function Home() {
      return (
        <div classNameName="topBarContainer">
          <div classNameName="topBarLeft">
            <Link style={{textDecoration:"none"}} to="/">
            <span  classNameName="logo">Tech Blog App</span>
            </Link>
          </div>
